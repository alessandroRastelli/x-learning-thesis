...
\label{subsec:coursera}
  ...
  \begin{minipage}{\linewidth}
      ...
      \captionof{figure}[Coursera logo]{Coursera logo}
  \end{minipage}
\\
...
\label{subsec:EdX}
  \begin{minipage}{\linewidth}
      ...
      \captionof{figure}[EdX logo]{EdX logo}
  \end{minipage}
\\
...
\begin{minipage}{\linewidth}
      ...
      \captionof{figure}[SkillShare logo]{SkillShare logo}
  \end{minipage}
  \\
...
\begin{minipage}{\linewidth}
      ...
      \captionof{figure}[Udacity logo]{Udacity logo}
  \end{minipage}
  \\
...
\begin{minipage}{\linewidth}
      ...
      \captionof{figure}[Udemy logo]{Udemy logo}
  \end{minipage}
  \\
